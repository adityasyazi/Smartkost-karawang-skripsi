...
if (!isset($_SESSION["username"])) {
    ...
    <h1 align='center' class='h1'> Anda harus login dulu </h1> <br><a href='../../login.php'>Klik disini untuk login</a>";
    exit;
}
...
<script type="text/javascript">
	...
	<div class="bodi">
		<!-- <?php echo "Halo Penghuni Room 1, Sekarang tanggal ".date('d F Y'); 
        echo "<br>";?> -->
        <h5 class="user" style="text-align: center">Selamat datang <?php echo $_SESSION['username'] ?>, sekarang tanggal <?php echo date('d-m-Y');?> | jam <a id="jam"></a>:<a id="menit"></a>:<a id="detik"></a></h5>
        <br>
		...
		<table>
 	 	...
 	 	<?php $no++ ?>
        	...
        	<tr>
 	 		...
 	 		<!-- 	<td><a class="btn btn-default" href="edit-berita.php?id=<?php echo $row['id_berita'];?>">Edit</a><a class="btn btn-alert" onclick="return confirm('Yakin akan menghapus berita ini?');" href="delete-berita.php?id=<?php echo $row['id_berita'];?>">Delete</a></td> -->
 	 		</tr>
            </tbody>
 	 		<?php endwhile; ?>
 	 </table>	
