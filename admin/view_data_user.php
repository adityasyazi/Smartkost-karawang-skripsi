...
$sql = ("SELECT user.username, user.password, user.is_admin, user.rfid, user.ruangan 
                FROM user");
...
<script >
	...
	<div class="bodi">
		<?php echo "Sekarang tanggal ".date('d-m-Y'); 
        echo "<br>";?>
        
        <?php
		 	echo '<br><a href="register.php" class="btn btn-small"><img src="../images/add.png"  style = "width: 15px;" />User</a>'; 
 		?>
		...
		<table>
 	 	...
 	 	<?php $no++ ?>
            ...
            <tr>
 	 			...
 	 			<td><?php if ($row['is_admin'] == 1){echo 'Admin';} elseif ($row['is_admin'] == 2){echo 'Penghuni A';} elseif ($row['is_admin'] == 3){echo 'Penghuni B';} ?></td>
     	 		<td><?php echo $row['rfid'];?></td>
 	 			<td><?php echo $row['ruangan'];?></td>
 	 			<!-- <td><?php echo $row['no_hp'];?></td>
 	 			<td><?php echo $row['email'];?></td>
 	 			<td><?php echo $row['moto'];?></td> -->
 	 			<td><!-- <a class="btn btn-default" href="edit-user.php?id=<?php echo $row['id_user'];?>">Edit</a> -->
                    <a class="btn btn-alert" onclick="return confirm('Yakin akan menghapus user ini?');" href="delete-user.php?id=<?php echo $row['id_user'];?>">Delete</a></td>
 	 		</tr>
            </tbody>
 	 		<?php endwhile; ?>
 	 </table>	
