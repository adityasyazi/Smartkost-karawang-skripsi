...
.button{
	...
	<div class="bodi">
		...
		<!-- lampu -->
			...
			<button class="button pressed" id="onlampu" onclick="onlampu()">ON</button>
				<img id="myImage" src="../images/<?php echo $lampu;?>" style="width:100px">
				
			<button class="buttonoff pressedoff" id="offlampu" style="color: rgb(blue);" onclick="offlampu()">OFF</button>
	
		<!-- kipas -->

			<script type="text/javascript"></script>
			
			<button class="button pressed" id="onkipas" onclick="onkipas()">ON</button>
				<img id="myImage1" src="../images/<?php echo $kipas;?>" style="width:140px">
			<button class="buttonoff pressedoff" id="offkipas" onclick="offkipas()">OFF</button>

		<!-- kunci -->
		<script type="text/javascript"></script>
			<button class="button pressed" onclick="bukakunci()">Buka</button>
				<img id="myImage2" src="../images/<?php echo $kunci;?>" style="width:150px">
			<button class="buttonoff pressedoff" onclick="tutupkunci()">Tutup</button>
	</div>
...
<script type="text/javascript">
	...
	function onkipas(){
		...
		client.get('http://smartkostkarawang.xyz/admin/setdatanew.php?kipas1=1', function(response) {
	...
	function offkipas(){
		...
		var client = new HttpClient();
		client.get('http://smartkostkarawang.xyz/admin/setdatanew.php?kipas1=0', function(response) {
		    console.log(response);
		});
	}
	...
	function onlampu(){
		...
		var client = new HttpClient();
		client.get('http://smartkostkarawang.xyz/admin/setdatanew.php?lampu1=1', function(response) {
		    console.log(response);
		});
	}
	function offlampu(){
		...
		var client = new HttpClient();
		client.get('http://smartkostkarawang.xyz/admin/setdatanew.php?lampu1=0', function(response) {
		    console.log(response);
		});
	}
	...
	function bukakunci(){
		...
		var client = new HttpClient();
		client.get('http://smartkostkarawang.xyz/admin/setdatanew.php?kunci1=1', function(response) {
		    console.log(response);
		});
	}
	function tutupkunci(){
		...
		var client = new HttpClient();
		client.get('http://smartkostkarawang.xyz/admin/setdatanew.php?kunci1=0', function(response) {
		    console.log(response);
		});
	}
</script>
